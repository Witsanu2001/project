    ...
    <form action="updatedata.php" method="POST">
      ...
      <div class="form-group col-6">
        ...
        <div>
          ...
          <div class="form-group">
            <label for="emp_surname">ชื่อเล่น :</label>
          ...
          <div class="form-group">
            <label for="emp_car">ข้อมูลรถ :</label>
            <textarea name="emp_car" class="form-control"><?php echo $row["emp_car"]; ?></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="my-3">
            ...
            <a href="insertEP.php" class="btn btn-primary">กลับหน้าแรก</a>
          </div>
    </form>
  </div>
